...
const Activities = () => {
    ...
    const fetchCourses = async (category) => {
        ...
        try {
            const response = await axios.get(
                'http://ec2-16-170-217-216.eu-north-1.compute.amazonaws.com:5000/api/courses/by-course-type',
                {
                    ...
                    if (course.providerId) {
                        try {
                            const providerResponse = await axios.get(
                                `http://ec2-16-170-217-216.eu-north-1.compute.amazonaws.com:5000/api/users/provider/${course.providerId}`
                            );
    ...
    const fetchAdvertisements = async () => {
        try {
            const response = await axios.get('http://ec2-16-170-217-216.eu-north-1.compute.amazonaws.com:5000/api/advertisement');
